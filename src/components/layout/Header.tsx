                        ...
                        <div className="mobile-topbar-right flex w-full sm:w-auto items-center justify-center gap-2 md:gap-4">
                            ...
                            <div className="mobile-socials flex items-center gap-1.5 md:gap-2">
                                ...
                                {settings.instagramUrl && (
                                    <a href={settings.instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram Go Nuts" className="w-9 h-9 md:w-6 md:h-6 rounded-full bg-[#9C7044] flex items-center justify-center text-white hover:bg-[#855D36] transition-all shadow-sm flex-shrink-0">
                                ...
                                {settings.youtubeUrl && (
                                    <a href={settings.youtubeUrl} target="_blank" rel="noopener noreferrer" aria-label="YouTube Go Nuts" className="w-9 h-9 md:w-6 md:h-6 rounded-full bg-[#9C7044] flex items-center justify-center text-white hover:bg-[#855D36] transition-all shadow-sm flex-shrink-0">
                                ...
                                {settings.tiktokUrl && (
                                    <a href={settings.tiktokUrl} target="_blank" rel="noopener noreferrer" aria-label="TikTok Go Nuts" className="w-9 h-9 md:w-6 md:h-6 rounded-full bg-[#9C7044] flex items-center justify-center text-white hover:bg-[#855D36] transition-all shadow-sm flex-shrink-0">
                        ...
                        <div className="site-header-row w-full flex items-center justify-between lg:w-auto">
                            <Link href="/" className="site-brand shrink-0 flex items-center gap-3 md:gap-4 group">
                                ...
                                <div className="site-brand-copy flex flex-col justify-center border-l-2 border-[#9C7044]/20 pl-3 md:pl-4">
                                    ...
                                    <span className="text-[10px] md:text-[11px] font-bold text-[#7d5a36] leading-tight mt-0.5 md:mt-1 italic">
