            ...
            <div className="container">
                <div className="footer-grid">
                    ...
                    <div className="footer-col company-info">
                        ...
                        <p className="company-name">Tên công ty</p>
                        <p>Địa chỉ: 998 Cầu giấy, Hà Nội</p>
                        <p>Số điện thoại: 090xxxxxxx</p>
                        <p>Email: contact.gonuts@gmail.com</p>
                        <p className="license">Số giấy phép kinh doanh: 0123xxxxxx</p>
                ...
                <div className="footer-bottom">
                    <p>© 2024 Go nuts | Designed by Go nuts</p>
                </div>
            </div>
        </footer>
    );
