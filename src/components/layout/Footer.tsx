        ...
        <footer className="footer">
            <div className="container">
                    ...
                    <div className="footer-col newsletter-col footer-newsletter">
                        ...
                        <div className="social-section">
                            ...
                            <div className="social-icons">
                                <a href={currentSettings.facebookUrl} target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Facebook Go Nuts">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                    </svg>
                                </a>
                                <a href={currentSettings.instagramUrl} target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram Go Nuts">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <a href={currentSettings.youtubeUrl} target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="YouTube Go Nuts">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" />
                                    </svg>
                                </a>
                                {currentSettings.tiktokUrl && (
                                    <a href={currentSettings.tiktokUrl} target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="TikTok Go Nuts">
                                        <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="footer-bottom">
                    <p>© 2024 {currentSettings.siteName} | Designed by Go Nuts</p>
                </div>
            </div>
        </footer>
    );
