                ...
                <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="hidden md:block w-full max-w-md relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border-transparent rounded-lg text-sm focus:bg-white dark:focus:bg-slate-900 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 dark:text-slate-200 transition-all outline-none"
                        />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="w-9 h-9 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center text-white font-semibold shadow-sm">
