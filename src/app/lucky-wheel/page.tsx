...
export default function LuckyWheelPage() {
    ...
    const visibleSpinHistory = data.history.slice(0, visibleHistoryCount);
    const visibleMoneyHistory = moneyHistory.slice(0, visibleMoneyCount);
