...
export async function GET(
    ...
    try {
        ...
        // Check if this order was referred by this agent
        ...
        const response = {
            ...
            // Customer info (show full info for agent since they referred the customer)
            customer: {
        ...
        console.error('Get agent order detail error:', error);
