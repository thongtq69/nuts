...
import {
    TrendingUp, DollarSign, ShoppingCart, Copy,
    RefreshCw, ArrowUpRight, Wallet, ExternalLink, Clock,
    ChevronRight, Sparkles, Link as LinkIcon, Users
} from 'lucide-react';
import {
    AreaChart,
    Area,
...
export default function CollaboratorDashboard() {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setStats({
                    ...
                    referralCode: (user as any)?.referralCode || 'CTV001',
                    recentOrders: data.orders?.slice(0, 5) || [],
                    commissionData: data.commissionData || mockCommissionData
                });
            } else {
                setStats(mockStats);
            }
    ...
    const mockCommissionData = [
        { date: '13/01', commission: 80000 },
        { date: '14/01', commission: 150000 },
        { date: '15/01', commission: 120000 },
        { date: '16/01', commission: 200000 },
        { date: '17/01', commission: 180000 },
        { date: '18/01', commission: 250000 },
        { date: '19/01', commission: 220000 },
    ];
    ...
    const statCards = [
        ...
        },
        {
            ...
            value: `${formatPrice(displayStats.totalRevenue)}d`,
            icon: TrendingUp,
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-brand via-brand-light to-amber-400 rounded-3xl p-6 sm:p-8 text-gray-800 shadow-2xl shadow-brand/20">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="font-semibold text-sm text-gray-900">Xin chao, {user?.name || 'Cong tac vien'}!</span>
                    </div>
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-2 text-gray-900">
                        Dashboard Cong tac vien
                    </h1>
                    <p className="text-gray-900 text-base sm:text-lg max-w-2xl mb-6 leading-relaxed opacity-90">
                        Theo doi don hang va hoa hong tu khach hang ban gioi thieu
                    </p>
                    ...
                    <div className="h-[300px] w-full min-h-[250px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={displayStats.commissionData} margin={{ top: 20, right: 30, left: 0, bottom: 20 }}>
                                <defs>
                                    <linearGradient id="colorCommissionCTV" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <div className="space-y-3">
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-gray-600 text-sm">{displayStats.totalOrders} don da gioi thieu</div>
                            </div>
